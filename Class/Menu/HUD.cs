...
public class HUD
{
    ...
    public void Draw(SpriteFont _font, Texture2D inventorySlot, Texture2D currentInventorySlot, Texture2D helmetFrame, Texture2D chestPlateFrame,Texture2D  bootsFrame)
    {
        if (Globals.gameState == State.Playing)
        {
            ...
            Globals.player.inventory.Draw(inventorySlot, currentInventorySlot,helmetFrame, chestPlateFrame, bootsFrame);
            DrawHPBar();
        }
    }
...
public class Inventory
{
    ...
    public void Draw(Texture2D inventorySlot, Texture2D currentInventorySlot, Texture2D helmetFrame, Texture2D chestPlateFrame, Texture2D bootsFrame)
    {
        ...
        DrawInInventory( helmetFrame,  chestPlateFrame,  bootsFrame);
    }
